...
- [~] **#61 T9.2** — D2 multi-runtime OTA backports (grilled 2026-09-13: manual `backport.yml`, tags + fix SHA inputs, fingerprint-equality gate, approval + rollout straight to production, prepared-branch path for conflicts; ADR-0008).
