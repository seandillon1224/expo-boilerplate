...
| `plan`          | Replaces `PLAN.md` with a stub pointing at the inherited decisions ([ADR-0001](adr/0001-locked-architecture-decisions.md), which ships in `docs/adr/`; `CLAUDE.md` and `docs/` cite it as "PLAN.md decision N") and at the upstream repo for the template's own build history                                                                                                                  | `--keep-plan`                                                                                      |
...
| `--keep-plan`           | Keep `PLAN.md` untouched (default: stub pointing at the inherited decisions)                                       | —                                                |
